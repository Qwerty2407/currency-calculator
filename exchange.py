...
window = Tk()
window.title("Currency calculator v.1")
...
c.create_text(50, 50, text="Select first currency", anchor=NW, font='Arial 18', fill="black")
p.create_text(50, 50, text="Select second currency", anchor=NW, font='Arial 18', fill="black")
c.create_text(50, 150, text="Indicate quantity", anchor=NW, font='Arial 18', fill="black")
...
btn = Button(text='Calculate', command=lambda: result_btn(combobox.get(), combobox2.get(), float(ent.get())))
